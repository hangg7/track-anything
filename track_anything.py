...
def parse_augment():
    ...
    parser.add_argument("--input_frame_pattern", type=str, default=None)
    parser.add_argument("--input_video_fps", type=float, default=None)
    parser.add_argument("--output_mask_dir", type=str, default=None)
    parser.add_argument("--gui_img_height", type=int, default=360)
